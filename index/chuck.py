...
class Chuck:
    facts = [
        ...
        "When Chuck Norris is doing a push-up, \
         he is not lifting himself up but pushing the earth down.",
        ...
        "If Chuck Norris was a Spartan in the movie 300, \
         the movie would be called 1.",
        "When Chuck Norris turned 18, his parents moved out.",
        "When Chuck Norris swims in the ocean, \
         the sharks are in a steel cage.",
